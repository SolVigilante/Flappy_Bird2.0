...
void draw_pipes(SDL_Renderer ** renderer, pipe_t * pipe){ //Creates the graphics for Pipe 1
...
void draw_pipes2(SDL_Renderer ** renderer, pipe_t * pipe){//Creates the graphics for Pipe 2
...
void draw_pipes3(SDL_Renderer ** renderer, pipe_t * pipe){//Creates the graphics for Pipe 3
...
void draw_pipes4(SDL_Renderer ** renderer, pipe_t * pipe){//Creates the graphics for Pipe 4
